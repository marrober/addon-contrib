...
import (
	...
	"cluster-info-addon/pkg/constants"
...
func init() {
	...
	utilruntime.Must(clusterinfov1alpha1.AddToScheme(scheme))
...
func (o *AgentOptions) AddFlags(cmd *cobra.Command) {
	...
	flags.BoolVar(&o.Verbose, "verbose", o.Verbose, "Log collected cluster version and operator information.")
}
...
func (o *AgentOptions) runControllerManager(ctx context.Context) error {
	...
	clusterInfoController := &ClusterInfoController{
	...
	if err = clusterInfoController.SetupWithManager(mgr); err != nil {
		return fmt.Errorf("unable to create clusterinfo agent controller: %s, err: %w", "clusterinfo-agent", err)
	}
